    ...
    <div className="flex justify-center items-center min-h-screen bg-secondary/50">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-3xl font-bold tracking-tight">TaskBoss</CardTitle>
          <CardDescription>
            The ultimate task management app with smart reminders
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-muted-foreground">
            Your tasks, deadlines & reminders in one place
          </p>
        </CardFooter>
      </Card>
    </div>
